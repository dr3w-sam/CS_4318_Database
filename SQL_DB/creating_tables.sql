...
FOREIGN KEY (campus_ID) references Semester (term_ID),
FOREIGN KEY (student_ID) references Campus (campus_ID));

CREATE TABLE Semester (
term_ID varchar(15) NOT NULL AUTO_INCREMENT,
campus_ID int,
...
electrical_output varchar(15) NOT NULL,
PRIMARY KEY (data_ID),
FOREIGN KEY (student_ID) references Student (student_ID),
